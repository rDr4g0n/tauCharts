...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('taucharts'), require('d3-array')) :
	typeof define === 'function' && define.amd ? define(['taucharts', 'd3-array'], factory) :
	(global.Taucharts = global.Taucharts || {}, global.Taucharts.Layers = factory(global.Taucharts,global.d3));
...
function Layers(xSettings) {
    ...
    settings.layers.forEach(function (layer) {
        layer.guide = utils.defaults((layer.guide || {}), {
            scaleOrient: 'left',
            textAnchor: 'end',
            hide: false
        });
    ...
    return {
        init: function (chart) {
            ...
            spec.setSettings('excludeNull', false)
                ...
                if (g) {
                    ...
                    return data.filter(function (row) {
                        return ((row[metaField] === layersText[k])
                            &&
                                (row[k] !== null)
                            &&
        ...
        onSpecReady: function (chart, specRef) {
            ...
            fullSpec = settings
                ...
                return memo.addScale(scaleName, Object.assign({ type: 'linear', source: '/', dim: scaleName, autoScale: true }, (utils.pick(layer.guide || {}, 'min', 'max', 'autoScale', 'nice', 'niceInterval'))));
            }, fullSpec);
