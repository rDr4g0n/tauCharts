...
(function (global, factory) {
	...
	(global.Taucharts = global.Taucharts || {}, global.Taucharts.GeomapLegend = factory(global.Taucharts));
    ...
    var plugin = {
        init: function (chart) {
            ...
            if (hasColorScales || hasFillScales) {
                ...
                if (hasColorScales) {
                    _delegateEvent(this._container, 'click', 'tau-chart__legend__item-color', function (e, currentTarget) {
                        this._toggleLegendItem(currentTarget);
                    }.bind(this));
                    _delegateEvent(this._container, 'mouseover', 'tau-chart__legend__item-color', function (e, currentTarget) {
                        this._highlightToggle(currentTarget, true);
                    }.bind(this));
                    _delegateEvent(this._container, 'mouseout', 'tau-chart__legend__item-color', function (e, currentTarget) {
