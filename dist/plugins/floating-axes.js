...
(function (global, factory) {
	...
	(global.Taucharts = global.Taucharts || {}, global.Taucharts.FloatingAxes = factory(global.Taucharts,global.d3));
}(this, (function (Taucharts,d3Selection) { 'use strict';
        ...
        createFloatingLayout: function () {
            ...
            function transferAxes(floating, axesInfo) {
                axesInfo.forEach(function (i) {
                    ...
                    if (animationSpeed) {
                        g.attr('transform', translate(i.parentTransform.translate0.x, i.parentTransform.translate0.y)).transition()
                            .duration(animationSpeed)
                            .attr('transform', translate(i.parentTransform.translate.x, i.parentTransform.translate.y));
                    }
                    else {
                        g.attr('transform', translate(i.parentTransform.translate.x, i.parentTransform.translate.y));
                    }
                    g.node()
                        .appendChild(i.axis);
                    // Save initial labels transform
                    Array.prototype.forEach.call(i.axis.querySelectorAll('.label'), function (label) {
            ...
            var xAxes = (function extractXAxes() {
                ...
                scrollManager
                    ...
                    var x = 0;
                    var yLimit = 0;
                    var y = Math.min((pos.visibleHeight + scrollTop - pos.svgHeight - pos.scrollbarHeight), yLimit);
                    g.attr('transform', translate(x, y));
                    labels.each(function () {
                        var t = parseTransform(this[transProp]);
                        var dx = -pos.svgWidth / 2 + pos.visibleWidth / 2 + scrollLeft;
                        this.setAttribute('transform', 'translate(' + (t.x + dx) + ',' + t.y + ') rotate(' + t.r + ')');
                    });
                });
                return g;
            })();
            var yAxes = (function extractYAxes() {
                ...
                scrollManager
                    ...
                    labels.each(function () {
                        ...
                        this.setAttribute('transform', 'translate(' + t.x + ',' + (t.y + dy) + ') rotate(' + t.r + ')');
                    });
                });
                return g;
            })();
            var corner = (function createCorner() {
                ...
                scrollManager
                    ...
                    var y = Math.min((scrollTop + pos.visibleHeight - xAxesHeight), yLimit);
                    g.attr('transform', translate(x, y));
                });
                return g;
            })();
            ...
            var shadows = (function createShadows() {
                ...
                var shadowEW = createShadow('ew', pos.visibleWidth - SHADOW_SIZE, pos.visibleHeight - xAxesHeight, SHADOW_SIZE, xAxesHeight);
                var shadowSN = createShadow('sn', 0, pos.visibleHeight - xAxesHeight - SHADOW_SIZE, yAxesWidth, SHADOW_SIZE);
                ...
                scrollManager
                    ...
                    toggle(shadowEW, (scrollLeft + pos.visibleWidth < pos.svgWidth) &&
                        (pos.svgWidth > pos.visibleWidth));
                    toggle(shadowSN, (scrollTop + pos.visibleHeight < pos.svgHeight) &&
        ...
        removeFloatingLayout: function () {
            ...
            function returnAxes(g) {
                g.selectAll('.axis').each(function () {
                    ...
                    Array.prototype.forEach.call(this.querySelectorAll('.label'), function (label) {
...
function ScrollManager(_scrollContainer) {
     ...
     */
    this.handleVisibilityFor = function (d3Selection$$1, scrollDirection) {
        if (scrollDirection.indexOf('x') >= 0) {
            items.x.push(d3Selection$$1);
        }
        if (scrollDirection.indexOf('y') >= 0) {
            items.y.push(d3Selection$$1);
        }
        return this;
    };
