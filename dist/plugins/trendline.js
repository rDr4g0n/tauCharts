...
(function (global, factory) {
	...
	(global.Taucharts = global.Taucharts || {}, global.Taucharts.Trendline = factory(global.Taucharts,global.d3));
    ...
    return {
        ...
        onSpecReady: function (chart, specRef) {
            ...
            specRef.transformations.regression = function (data, props) {
                ...
                var y = props.y.dim;
                var g = props.g.dim;
                var isXPeriod = Boolean(props.x.period);
                var isYPeriod = Boolean(props.y.period);
                ...
                return Object.keys(groups).reduce(function (memo, k) {
                    var fiber = groups[k];
